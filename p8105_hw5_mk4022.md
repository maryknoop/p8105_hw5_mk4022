...
The differences are significant between some groups, as seen by the
color gradient depciting different id numbers. The values for each
subject also changes significantly from week to week for each individual
id number.
